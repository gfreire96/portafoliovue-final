<script setup>
import proyecto1 from '/src/assets/final-CyoDbMaO.png';
import proyecto2 from '/src/assets/mona.webp';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Generación de mapas con autómata celular",
        descripcion: "Implementé un sistema de generación de mapas de forma procedural con autómata celular para un juego rogue-like",
        projectoLink: "https://www.youtube.com/playlist?list=PLeO2T8e-S41jlMtu6rqjQf31r7TK0Pgrn",
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Trabajo de cierre de año",
        descripcion: "Aplicación de gestión de bibliotecas. [Próximamente]",
        projectoLink: "",
    },
])
